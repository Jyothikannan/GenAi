...
# Stream UI
st.title("XYZ - YouTube/Uploaded Video Summarizer using Groq LLM")

# Add an image link
st.image("https://example.com/your-image.jpg", caption="Video Summarizer")

youtube_url = st.text_input("Paste a YouTube video URL:", placeholder="https://www.youtube.com/watch?v=example")

# Handle video input YouTube URL
if youtube_url:
    try:
